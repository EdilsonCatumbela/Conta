...
public class ExArrayListProf {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      int i = showOptionDialog(null, "Escolha uma opcaoo", 
        "Cadastro de Professores", 0, 3, null, new String[]{"Incluir",
        "Excluir","Alterar","Consultar","Relatorio", "Sair"},"Incluir");
      if (i == -1) 
		    System.exit(0);
      if (i == 0) 
		    incluir();
  ...
  private static void incluir() {
    ...
    if (lista.contains(prof)) {
	    showMessageDialog(null, "Professor ja cadastrado!","Erro",ERROR_MESSAGE);
      return;
    }
    
    String str = showInputDialog("Informe o nome do professor: ");
    while (str.isEmpty()){
		showMessageDialog(null, "O nome precisa ser preenchido!","Alert",WARNING_MESSAGE);
		str = showInputDialog("Informe o nome do professor: ");
	}	
  ...
  private static void excluir() {
    ...
    if (posicao == -1) {
      showMessageDialog(null, "Esse professor nao existe no cadastro " + prof.getNomeProf(),"Erro",ERROR_MESSAGE);
      return;
    }
  ...
  private static void consultar() {
	...
	private static void relatorio() {
		String str = "Relatorio de Professores:\n";
